...
<html>
<head>
    <title>Solicitação de cancelamento rejeitada</title>
</head>
<body>
    <h1>Solicitação de cancelamento rejeitada</h1>
    
    <p>Olá {{ $travelRequest->requester_name }},</p>
    
    <p>Sua solicitação de cancelamento de viagem foi rejeitada:</p>
